// ↓ Open the below links (site-wide) in new tab:

$('a[href="/listen"] ').attr('target','_blank')
$('a[href="/pages/listen"] ').attr('target','_blank')
$('a[href="http://m.BibleAud.io"] ').attr('target','_blank')
$('a[href="http://BibleAud.io"] ').attr('target','_blank')
$('a[href="http://m.lilBible.com"] ').attr('target','_blank')
$('a[href="http://lilBible.com"] ').attr('target','_blank')
$('a[href="http://m.BibleBeatz.com"] ').attr('target','_blank')
$('a[href="http://BibleBeatz.com"] ').attr('target','_blank')
$('a[href="http://m.WalkOnWavs.com"] ').attr('target','_blank')
$('a[href="http://WalkOnWavs.com"] ').attr('target','_blank')

// ↑ Open the above links (site-wide) in new tab:
